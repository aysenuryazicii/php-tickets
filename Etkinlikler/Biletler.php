...
<head>
  ...
  <meta property="og:title" content="Biletler">
...
<body class="u-body">
      ...
      <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
        <div class="u-custom-menu u-nav-container">
          <ul class="u-nav u-unstyled u-nav-1">
            <li class="u-nav-item">
              <a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="../Anasayfa/index.php" style="font-size: 16px; padding: 10px 20px;">Ana Sayfa</a>
            </li>
            <li class="u-nav-item">
              <a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Biletler.php" style="font-size: 16px; padding: 10px 20px;">Biletler</a>
            </li>
            ...
            if (isset($_SESSION["ID"])) {
              ...
              href="#" style="font-size: 16px; padding: 10px 20px;">' . $f_name . '</a>
              </li>
              <a href="../logout.php">
            ...
            ';
              ...
              echo '
            <li class="u-nav-item">
              <a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" style=" font-size: 16px; padding: 10px 20px;" type="button" data-toggle="modal" data-target="#myModal">Giriş Yap</a>
              <!-- Modal -->
                    ...
                    <div class="modal-body">
                      <div class="signup-form">
                        <form method="post">
                          ...
                          <div class="form-group">
                            <button type="submit" name="save" class="btn btn-success btn-lg btn-block u-btn u-button-style u-palette-2-base" style="background-color: #db545a; border-color: #db545a;" padding: 10px 20px;">Giriş Yap</button>
                          </div>
            ...
            <li class="u-nav-item">
              <a  class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" style="font-size: 16px; padding: 10px 20px;" type="button" data-toggle="modal" data-target="#myModal1">Kayıt Ol</a>
                    ...
                    <div class="modal-body">
                      <div class="signup-form">
                        <form action="../signup_db.php" method="post">
                          <h2 style="font-size:30px">Kayıt Ekranı</h2>
                          <p class="hint-text" style="font-size:16px">Hesap Oluştur</p>
                          <div class="form-group">
  ...
  <body class="u-body">
    ...
    echo '<section class="u-align-center u-clearfix u-section-1" id="sec-2163">
    <div class="u-clearfix u-sheet u-sheet-1">
      <h2 class="u-text u-text-default u-text-1" style="font-size: 45px;">ETKİNLİKLER</h2>
      <p class="u-text u-text-default u-text-2" style="font-size: 20px;">ETKİNLİKLER HAKKINDA BİLGİLER</p><div class="u-expanded-width u-list u-list-1">';

    while ($str = mysqli_fetch_assoc($sorgu)) {
      $id = $str["id"];
      $price = $str['price'];
      $quantity = $str['quantity'];
      $date = date_format(date_create($str['date']), "d/m/Y");
      $now_date = date("d/m/Y");

      if (!strcmp($date, $now_date)) {
        // Etkinlik tarihi o gün ise db üzerinden etkinlik silinir
        $delete = mysqli_query($con, "DELETE FROM tickets_info WHERE id=$id");
      }
      if ($quantity <= 0) {
        echo ' 
        <div class="u-align-center u-container-style ">
          <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1"><span class="u-file-icon u-grey-15 u-icon u-icon-rounded u-spacing-10 u-icon-1"><img src="images/195123.png" alt=""></span>
            <div class="ticket" style="width: 200px;" >
                <h3 class="u-align-center u-text u-text-3">' . $str['name'] . '</h3>
                  <span class="price">' . $price . '₺</span><br/>
                  <p class="u-large-text u-text u-text-default u-text-variant u-text-2">' . $date  . '</p>
                  <div class="quantity">' . 'Kalan bilet sayısı: ---</div><br/> 
            </div>
                <a href="" class="u-active-none u-border-2 u-border-palette-2-light-1 u-btn u-btn-rectangle u-button-style u-hover-none u-none u-text-body-color u-btn-1 " style="pointer-events: none;  font-weight:bolder">TÜKENDİ</a>     
        </div>';
      } else {
        echo ' 
        <div class="u-align-center u-container-style ">
          <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1"><span class="u-file-icon u-grey-15 u-icon u-icon-rounded u-spacing-10 u-icon-1"><img src="images/195123.png" alt=""></span>
            <div class="ticket" style="width: 200px;">
                <h3 class="u-align-center u-text u-text-3">' . $str['name'] . '</h3>
                  <span class="price">' . $price . '₺</span><br/>
                  <p class="u-large-text u-text u-text-default u-text-variant u-text-2">' . $date . '</p>
                  <div class="quantity">' . 'Kalan bilet sayısı: ' . $quantity . '</div><br/> 
            </div>
                <a href="../buy.php?id=' . $id . '" class="u-active-none u-border-2 u-border-palette-2-light-1 u-btn u-btn-rectangle u-button-style u-hover-none u-none u-text-body-color u-btn-1">BİLET
                  AL</a>     
        </div>';
      }
      echo '
    ...
    <section class="u-backlink u-clearfix u-grey-80" style="font-size:13px">
